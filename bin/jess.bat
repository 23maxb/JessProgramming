...
rem set JAVA_HOME = "C:\Program Files\Java\jre1.6.0_07"
rem JAVA_HOME points to the directory just above the bin directory
rem which is where java.exe is located.
